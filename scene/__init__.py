...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, fmodel_path0=None, model_path=None, argstest=None, train_image_data=None, test_image_data=None,
        ...
        if load_iteration:
            if load_iteration == -1:
                self.loaded_iter0 = searchForMaxIteration(os.path.join(self.model_path0,"point_cloud"))
                self.loaded_iter = searchForMaxIteration(os.path.join(self.model_path,"point_cloud"))
            else:
                self.loaded_iter0 = load_iteration
    ...
    def save(self, iteration, mask=None, save_point_cloud=False):
        ...
        if save_point_cloud:
            ...
            self.gaussians.save_ply_lod(os.path.join(self.model_path, 'point_cloud.ply'))
